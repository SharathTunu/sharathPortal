(function() {
  ...
  /**
   * Big Picture — only anchors with .portfolio-lightbox (RAG tile is excluded).
   */
   document.querySelectorAll("a.portfolio-lightbox").forEach((function(e) {
